                      ...
                      <div className={styles.thumbnail}>
                        ...
                        <dl>
                          {amusement.animeBroadcast2 !== null && platform !== amusement.animeBroadcast2 && (
                            <div
                              className={`${styles.anime2} ${amusement.ott === 'disneyOriginal' || amusement.ott === 'disneyStar' ? styles.broadcasts : ''} ${platform === amusement.animeBroadcast1 ? styles.anime2only : ''}`}
                            >
                              <dt>한국 애니 방송사</dt>
                              <dd>
                                {amusement.animeBroadcast2 === 'aniplus' && (
                          ...
                          {amusement.animeBroadcast1 !== null && platform !== amusement.animeBroadcast1 && (
                            <div
              ...
              <div className={styles.headline}>
                ...
                <div className={styles.select}>
                  <select value={selectedHanguk} onChange={handleHangukChange}>
                    ...
                    <option value="anything,game">지원 게임 전체</option>
            ...
            <div className={styles.content}>
              <div className={`${styles.headline} ${styles['without-select']}`}>
                <h1 className="April16thPromise">
                  <em>
                    `{literatureData.attributes.subject}`{' '}
                    {literatureData.attributes.type === 'franchise'
                      ? '프랜차이즈'
                      : literatureData.attributes.isGame
                        ? '게임'
                        : '관련 작품'}
                  </em>{' '}
                        ...
                        >
                          ...
                          {amusement.category !== 'game_fan' && (
                            <dl>
                              ...
                              {amusement.broadcast !== null && (
                                <div
                                  className={`${styles.broadcast} ${amusement.ott !== null ? styles.broadcasts : ''}`}
                                >
                                  <dt>드라마 송출 방송국</dt>
                                  <dd>
                                    {amusement.broadcast === 'ENA' && (
...
function HangukTitle(hanguk: keyof typeof HangukTitle, category?: string): string {
  const hangukTitles = {
    subtitle: category === 'game' ? '한글 UI 또는\n자막 공식 지원 게임!!' : '한글 자막\n공식 지원',
    dubbing: '한국어 더빙\n공식 지원!',
    unofficial: category === 'game' ? '비공식\n한글 자막 지원 게임!' : '',
    cc: '청각 장애인용\n자막 지원!',
    description: '화면 해설\n지원',
