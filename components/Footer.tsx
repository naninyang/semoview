      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <div className={styles.law}>
            <dl>
              <div>
                <dt>
                  <button type="button" onClick={() => toggleVisibility('sourceCopyright')}>
                    소스 저작권 안내
                  </button>
                </dt>
                <dd>
              ...
              <div>
                <dt>
                  <button type="button" onClick={() => toggleVisibility('ottRights')}>
                    OTT 서비스 및 방송사의 권리
                  </button>
                </dt>
                <dd>
          ...
          <div className={styles.etc}>
            <dl>
              <div>
                <dt>
                  <button type="button" onClick={() => toggleVisibility('ratingInfo')}>
                    심의등급 안내
                  </button>
                </dt>
                <dd>
              ...
              <div>
                <dt>
                  <button type="button" onClick={() => toggleVisibility('barrierFreeContent')}>
                    베리어프리 콘텐츠 표시
                  </button>
                </dt>
                <dd>
        ...
        <div className={styles.scp}>
          <dl>
            <div>
              <dt>
                <button type="button" onClick={() => toggleVisibility('scpLicense')}>
                  SCP 재단 콘텐츠 라이선스
                </button>
              </dt>
              <dd>
