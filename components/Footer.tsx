    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <p className={styles.copyright}>
          &copy; Copyright <strong>DEV1.studio</strong> <span>All rights reserved.</span>
        </p>
        ...
        <p className={styles.scp}>
          ...
          컨셉의 출처는 https://scpwiki.com/ 및 해당 저자에서 비롯됩니다.{' '}
          <span>이 콘텐츠들에서 파생된 본 영상은 이에 따라 크리에이티브 커먼즈 Sharealike 3.0에 따라 배포됩니다.</span>
        </p>
      </div>
    </footer>
  );
